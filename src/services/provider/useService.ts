import { ServicesProviderContext } from './ServicesProvider';
import type { ServiceConstructorClass } from './ServiceResolverClass';
 ...
 */
export function useService<T extends ServiceConstructorClass>(
    serviceClass: T
): InstanceType<T>;
/**
